...
extension ChannelSecretsTableViewController {
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        ZerekAISDK.initialize(settings: settings, verbose: true)
        ...
        ZerekAISDK.set(language: locale)
        ...
        let user = ZerekAIUser(
            ...
            gender: ZerekAIUser.Gender(rawValue: userConfig.gender),
            age: userConfig.age,
            userCoordinate: location
        )

        ZerekAISDK.start(user: user, completion: nil)
