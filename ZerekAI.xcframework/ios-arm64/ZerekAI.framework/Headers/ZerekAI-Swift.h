...
#ifndef ZEREKAI_SWIFT_H
#define ZEREKAI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ZerekAI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC7ZerekAI6APView")
...
SWIFT_CLASS("_TtC7ZerekAI28AnimatedCollectionViewLayout")
...
SWIFT_CLASS("_TtC7ZerekAI38AnimatedCollectionViewLayoutAttributes")
